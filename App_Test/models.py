...
class Lesson(models.Model):
    lesson_id = models.IntegerField(db_column='Lesson_Id', primary_key=True)  # Field name made lowercase.
    ...
    excel_id = models.IntegerField(db_column='Excel_Id')  # Field name made lowercase.
...
class LessonStudent(models.Model):
    lesson = models.OneToOneField(Lesson, models.DO_NOTHING, db_column='Lesson_Id', primary_key=True)  # Field name made lowercase.
